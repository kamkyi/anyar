  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('dashboard') }}" class="brand-link">
      <img src="{{ asset('dist/img/anyar.jpg') }}" alt="Anyar logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('/dashboard') }}" class="nav-link {{ active_class(request()->is('dashboard*')) }}">
          ...
          <li class="nav-item">
            <a href="{{ route('backend.flower.index') }}" class="nav-link {{ active_class(request()->is('flower*')) }}">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link" id="logout-now">
              <i class="nav-icon far fa-circle text-danger"></i>
              <p>Logout</p>
            </a>
          </li>
